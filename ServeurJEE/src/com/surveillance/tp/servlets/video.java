...
public class video extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(session.getAttribute("groupeUtilisateur").equals("eleve")) response.sendRedirect(request.getContextPath()+"/monCompte");
		else {
		...
		getServletContext().getRequestDispatcher("/WEB-INF/Video.jsp").forward(request, response);        
	}
}